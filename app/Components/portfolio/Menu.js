...
const Menu =[
  {
    ...
    category: "Project",
    content: "HTML5, CSS, JavaScript로 전체적인 웹 페이지를 디자인하고, Spring 및 MyBatis를 이용하여 로그인, 파티 등의 CRUD 기능을 개발했습니다. 인기 TOP10 목록은 JSOUP을 활용하여 데이터 크롤링을 수행하여 구현하였고, 파티 가입 시에는 PortOne 결제 API를 통해 테스트 결제를 처리했습니다.",
    url: "https://github.com/pangyosim/strawberr7",
    iname: "fa-brands fa-github",
    buttontitle: "Github",
    site:"http://site.oyes.o-r.kr/"
  },
  {
    id:2,
    image: "/img/dwbbmainimg.png",
    ...
    url:"https://github.com/pangyosim/pizzapr0ject",
    iname: "fa-brands fa-github",
    buttontitle: "Github"
  },
  {
    ...
    category: "Blog",
    content:"기록하지 않고 기억하는것은 언젠가 사라질 데이터가 될 위험이 있기 때문에 더욱 성장하기 위해 공부한 내용을 정리해서 올릴 블로그를 운영하기 시작했습니다.",
  ...
  },
  {
    ...
    category: "Blog",
    content:"교육 내용, 알고리즘, 개발공부들을 하며 결과물들을 노션에 저장하고 있습니다. 알고리즘을 공부할 때는 개념을 먼저 공부한 후 관련된 문제들을 푸는 것을 적어나가고 있습니다. 매일 학습 내용을 적는 습관을 들어 공부를 지속하고 있습니다.",
    url:"https://pgportfolio.notion.site/SIMPANGYO-DB-096dfd3881ea47bb8c48a4b4913f42af?pvs=4",
    iname: "fa-brands fa-neos",
    buttontitle: "notion"
  },
  {
    id:5,
    image: "/img/githubpage.png",
    title:"프로젝트들이 업로드되어있는 Github",
    category: "Blog",
    content:"프로젝트, 개발공부들을 하며 결과물들을 깃허브에 저장하고 있습니다. 프로젝트를 진행할 때는 해당 프로젝트의 설계나 고민했던 것을 적어가고 있습니다.",
