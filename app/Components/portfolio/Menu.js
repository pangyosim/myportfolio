...
const Menu =[
  {
    ...
    subtitle:"/img/devcvlogo.png",
    subcontent:"자신에게 맞는 참고 이력서를 찾아주는",
    innercontent:"판매자의 스펙과 자료를 검증하여 판매자의 신뢰성을 높이고, 구매자에게 적합한 자료를 구매하도록 하여 구매자의 구직 활동에 도움을 줄 수 있는 서비스를 기획하였습니다.",
    category: "PROJECT",
    ...
    main: {
      ...
      deadline: "기간:2024.05~2024.07(8주)",
      members: "FRONTEND:1 BACKEND:3",
  ...
  },
  {
    ...
    main: {
      ...
      deadline: "기간:2023.12~2024.02(8주)",
      members: "BACKEND:3",
